...
** STEP ELEVEN - Extract, install and verify OPENSSL: **
```
...
** STEP TWOELVE - Open your shell's configuration file (~/.zshrc for zsh or ~/.bash_profile for bash) in your preferred text editor and add the following line:**
```
